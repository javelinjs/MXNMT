...
class MaskedBucketSentenceIter(mx.io.DataIter):
    def __init__(self, source_path, target_path, source_vocab, target_label_size,
        ...
        if label2id is None:
            self.label2id = default_text2label
        else:
        ...
        self.provide_data = [(source_data_name, (batch_size, self.default_bucket_key)),
                             (source_mask_name, (batch_size, self.default_bucket_key))] \
                            + source_init_states
